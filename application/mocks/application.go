...
import (
	...
	application "github.com/Math2121/hexago/application"
...
// MockProducerWriter is a mock of ProducerWriter interface.
type MockProducerWriter struct {
	ctrl     *gomock.Controller
	recorder *MockProducerWriterMockRecorder
}

// MockProducerWriterMockRecorder is the mock recorder for MockProducerWriter.
type MockProducerWriterMockRecorder struct {
	mock *MockProducerWriter
}

// NewMockProducerWriter creates a new mock instance.
func NewMockProducerWriter(ctrl *gomock.Controller) *MockProducerWriter {
	mock := &MockProducerWriter{ctrl: ctrl}
	mock.recorder = &MockProducerWriterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProducerWriter) EXPECT() *MockProducerWriterMockRecorder {
	return m.recorder
}

// Save mocks base method.
func (m *MockProducerWriter) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProducerWriterMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProducerWriter)(nil).Save), product)
}
